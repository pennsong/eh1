	...
	{		
		jQuery("#talent_name_sort").change(function() {
  			if (jQuery(this).val() == 0)
  			{
    			...
    			jQuery("#views-exposed-form-company-trade-list-page-1").submit();			
  			}
...
<div>
	...
	<div class="content inline_block" style="width:80px">
	...
	<div class="inline_block" style="width:80px">
		<?php echo str_replace('不限', '城市筛选', $widgets['filter-field_job_city_tid']->widget); ?>
	</div>
	<div class="inline_block" style="width:100px">
		<input id="edit-title-1" class="form-text" type="text" maxlength="50" size="10" value="<?php echo (isset($_GET['title_1'])?$_GET['title_1']:''); ?>" name="title_1">
	</div>
